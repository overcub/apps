...
switch($ambient){
    ...
    case AMBIENT_LOCAL:
        ...
        $CONFIG['database'][1]['connectionString'] = 'mysql:host='.$localHostDB.';dbname=apps.geeklifeclub';
        $CONFIG['database'][1]['username'] = 'geeklifeclub';
        $CONFIG['database'][1]['password'] = 'geeklifeclubaabc33163356';
        $CONFIG['database'][2]['connectionString'] = 'mysql:host='.$localHostDB.';dbname=apps.geeklifeclub';
        $CONFIG['database'][2]['username'] = 'geeklifeclub';
        $CONFIG['database'][2]['password'] = 'geeklifeclubaabc33163356';
        ...
        $CONFIG['params']['cdnUrl'] = 'http://local.app.manete.tv/';
        $CONFIG['params']['defaultUrl'] = 'http://local.app.manete.tv/';
