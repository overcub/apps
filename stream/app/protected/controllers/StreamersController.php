...
class StreamersController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Streamers');
	...
	{
		$model=new Streamers('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Streamers']))
			$model->attributes=$_GET['Streamers'];
	...
	{
		$model=Streamers::model()->findByPk($id);
		if($model===null)
			throw new CHttpException(404,'The requested page does not exist.');
		return $model;
	}
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='streamers-form')
		{
